...
// *************沁水形成区范围
export const mapCenter = [114.48338, 29.666581]
export const mapZoom = 10
export const mapXzqhUrl = 'http://10.0.200.201/server/rest/services/XianNingRegion/MapServer/0'
...
dataRequestUrl.options = {
  ...
  // 'pollution_cloudImageUrl': datacloudurl + '/wrytgy/wrytresultgy/current/',
  // 'pollutionhis_cloudImageUrl': datacloudurl + '/wrytgy/wrytresultgy/',
  // 咸宁
  'pollution_cloudExtentUrl': {xmin: 12638325.431141887, ymin: 3379817.4443841665, xmax: 12798180.21992103, ymax: 3542398.6991717587, spatialReference: {wkid: 3857}},
  'pollution_cloudImageUrl': datacloudurl + '/xianning/wrytresultly/current/',
  'pollutionhis_cloudImageUrl': datacloudurl + '/xianning/wrytresultly/',
  // 风场数据设置
