!(function (e) {
  ...
  var t = e.exports = typeof window !== 'undefined' && window.Math == Math ? window : typeof self !== 'undefined' &&
  ...
  function l (e, n) {
    if (e != null) {
      if (typeof e !== 'object' && (e = [e]), s(e)) { for (var t = 0, r = e.length; t < r; t++) n.call(null, e[t], t, e) } else { for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && n.call(null, e[o], o, e) }
    }
  }
  e.exports = {
    isArray: s,
    ...
    isStandardBrowserEnv: function () {
      return (typeof navigator === 'undefined' || navigator.product !== 'ReactNative' && navigator.product !== 'NativeScript' &&
				navigator.product !== 'NS') && (typeof window !== 'undefined' && typeof document !== 'undefined')
    },
    forEach: l,
    merge: function e () {
      var n = {}
      ...
      function t (t, r) {
        typeof n[r] === 'object' && typeof t === 'object' ? n[r] = e(n[r], t) : n[r] = t
      }
    ...
    deepMerge: function e () {
      ...
      function t (t, r) {
        typeof n[r] === 'object' && typeof t === 'object' ? n[r] = e(n[r], t) : n[r] = typeof t === 'object' ? e({}, t)
          : t
      }
      for (var r = 0, o = arguments.length; r < o; r++) l(arguments[r], t)
      return n
    ...
    extend: function (e, n, t) {
      return l(n, function (n, o) {
        e[o] = t && typeof n === 'function' ? r(n, t) : n
      }), e
    },
    trim: function (e) {
  ...
  var r = t(1),
    ...
    a = function (e, n, t) {
      ...
      for (l in p && (t = n), t) {
        u = ((c = !f && g && void 0 !== g[l]) ? g : t)[l], v = j && c ? A(u, r) : h &&
				typeof u === 'function' ? A(Function.call, u) : u, g && s(g, l, u, e & a.U), b[l] != u && i(b, l, v), h && m[l] !=
				u && (m[l] = u)
      }
    }
  ...
  (function (e, r) {
    ...
    (function () {
      ...
      function g (e) {
        return e == null ? d(e) : p.call(e).slice(8, -1)
      }
      ...
      function m (e, n) {
        ...
        return (function (e, n) {
          var t = -1,
            r = e ? e.length : 0
          if (typeof r === 'number' && r > -1 && r <= c) { for (; ++t < r;) n(e[t], t, e) } else j(e, n)
        }(e, function (r, o) {
          t = n(t, r, o, e)
        })), t
      }
      ...
      var y = (function e (n) {
        var t = s,
          r = n && typeof n === 'object' && g(n) != 'String'
        r && (t = n, n = null)
        var o = t.navigator || {},
          i = o.userAgent || ''
        n || (n = i)
        var A, a, l, c, v, f = r ? !!o.likeChrome : /\bChrome\b/.test(n) && !/internal|\n/i.test(p.toString()),
          ...
          O = null,
          C = n == i,
          D = C && Y && typeof Y.version === 'function' && Y.version(),
          L = m([{
            label: 'EdgeHTML',
            pattern: 'Edge'
          }, 'Trident', {
        ...
        if (L && (L = [L]), R && !Q && (Q = F([R])), (A = /\bGoogle TV\b/.exec(Q)) && (Q = A[0]), /\bSimulator\b/i.test(
          n) && (Q = (Q ? Q + ' ' : '') + 'Simulator'), G == 'Opera Mini' && /\bOPiOS\b/.test(n) && k.push(
          'running in Turbo/Uncompressed mode'), G == 'IE' && /\blike iPhone OS\b/.test(n) ? (R = (A = e(n.replace(
          /like iPhone OS/, ''))).manufacturer, Q = A.product) : /^iP/.test(Q) ? (G || (G = 'Safari'), Z = 'iOS' + ((A =
						/ OS ([\d_]+)/i.exec(n)) ? ' ' + A[1].replace(/_/g, '.') : '')) : G != 'Konqueror' || /buntu/i.test(Z) ? R &&
					R != 'Google' && (/Chrome/.test(G) && !/\bMobile Safari\b/i.test(n) || /\bVita\b/.test(Q)) || /\bAndroid\b/.test(
          Z) && /^Chrome/.test(G) && /\bVersion\//i.test(n) ? (G = 'Android Browser', Z = /\bAndroid\b/.test(Z) ? Z
            : 'Android') : G == 'Silk' ? (/\bMobi/i.test(n) || (Z = 'Android', k.unshift('desktop mode')),
          /Accelerated *= *true/i.test(n) && k.unshift('accelerated')) : G == 'PaleMoon' && (A =
						/\bFirefox\/([\d.]+)\b/.exec(n)) ? k.push('identifying as Firefox ' + A[1]) : G == 'Firefox' && (A =
						/\b(Mobile|Tablet|TV)\b/i.exec(n)) ? (Z || (Z = 'Firefox OS'), Q || (Q = A[1])) : !G || (A = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(G)) ? (G && !Q && /[\/,]|^[^(]+?\)/.test(n.slice(n
                .indexOf(A + '/') + 8)) && (G = null), (A = Q || R || Z) && (Q || R ||
						/\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(Z)) && (G = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(Z)
                ? Z : A) + ' Browser')) : G == 'Electron' && (A = (/\bChrome\/([\d.]+)\b/.exec(n) || 0)[1]) && k.push(
          ...
          return e || (RegExp(t + '(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)', 'i').exec(n) || 0)[1] ||
							null
        })), (A = (L == 'iCab' && parseFloat(D) > 3 ? 'WebKit' : /\bOpera\b/.test(G) && (/\bOPR\b/.test(n) ? 'Blink'
          : 'Presto')) || /\b(?:Midori|Nook|Safari)\b/i.test(n) && !/^(?:Trident|EdgeHTML)$/.test(L) && 'WebKit' || !L &&
						/\bMSIE\b/i.test(n) && (Z == 'Mac OS' ? 'Tasman' : 'Trident') || L == 'WebKit' &&
						/\bPlayStation\b(?! Vita\b)/i.test(G) && 'NetFront') && (L = [A]), G == 'IE' && (A = (
          ...
          k.unshift('desktop mode'), D || (D = (/\brv:([\d.]+)/.exec(n) || 0)[1])) : G != 'IE' && L == 'Trident' && (A =
						/\brv:([\d.]+)/.exec(n)) && (G && k.push('identifying as ' + G + (D ? ' ' + D : '')), G = 'IE', D = A[1]), C
        ) {
          if (c = 'global', v = (l = t) != null ? typeof l[c] : 'number', /^(?:boolean|number|string|undefined)$/.test(
            v) || v == 'object' && !l[c]) {
            g(A = t.runtime) == d ? (G = 'Adobe AIR', Z = A.flash.system.Capabilities.os)
              : g(A = t.phantom) == w ? (G = 'PhantomJS', D = (A = A.version || null) && A.major + '.' + A.minor + '.' + A.patch)
                : typeof T.documentMode === 'number' && (A = /\bTrident\/(\d+)/i.exec(n)) ? (D = [D, T.documentMode], (A = +A[1] +
							4) != D[1] && (k.push('IE ' + D[1] + ' mode'), L && (L[1] = ''), D[1] = A), D = G == 'IE' ? String(D[1].toFixed(
                  1)) : D[0]) : typeof T.documentMode === 'number' && /^(?:Chrome|Firefox)\b/.test(G) && (k.push('masking as ' +
            ...
            typeof t.process === 'object' && !t.process.browser && (A = t.process) && (typeof A.versions === 'object' &&
						(typeof A.versions.electron === 'string' ? (k.push('Node ' + A.versions.node), G = 'Electron', D = A.versions
						  .electron) : typeof A.versions.nw === 'string' && (k.push('Chromium ' + D, 'Node ' + A.versions.node), G =
        ...
        if (D && (A = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(D) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ';' + (
          ...
          RegExp(A + '\\+?$'), '') + (O == 'beta' ? N : E) + (/\d+\+?/.exec(A) || '')), G == 'Fennec' || G ==
					'Firefox' && /\b(?:Android|Firefox OS)\b/.test(Z)) G = 'Firefox Mobile'
        else if (G == 'Maxthon' && D) D = D.replace(/\.[\d.]+/, '.x')
        else if (/\bXbox\b/i.test(Q)) {
          Q == 'Xbox 360' && (Z = null), Q == 'Xbox 360' && /\bIEMobile\b/.test(n) && k.unshift(
            'mobile mode')
        } else if (!/^(?:Chrome|IE|Opera)$/.test(G) && (!G || Q || /Browser|Mobi/.test(G)) || Z != 'Windows CE' && !/Mobi/i.test(n)) {
          if (G == 'IE' && C) {
            try {
              t.external === null && k.unshift('platform preview')
            } catch (e) {
              k.unshift('embedded')
            }
          } else {
            (/\bBlackBerry\b/.test(Q) || /\bBB10\b/.test(n)) && (A = (RegExp(Q.replace(/ +/g, ' *') + '/([.\\d]+)',
              'i').exec(n) || 0)[1] || D) ? (Z = ((A = [A, /BB10/.test(n)])[1] ? (Q = null, R = 'BlackBerry')
                : 'Device Software') + ' ' + A[0], D = null) : this != j && Q != 'Wii' && (C && Y || /Opera/.test(G) &&
							/\b(?:MSIE|Firefox)\b/i.test(n) || G == 'Firefox' && /\bOS X (?:\d+\.){2,}/.test(Z) || G == 'IE' && (Z &&
								!/^Win/.test(Z) && D > 5.5 || /\bWindows XP\b/.test(Z) && D > 8 || D == 8 && !/\bTrident\b/.test(n))) &&
						!u.test(A = e.call(j, n.replace(u, '') + ';')) && A.name && (A = 'ing as ' + A.name + ((A = A.version)
                ? ' ' + A : ''), u.test(G) ? (/\bIE\b/.test(A) && Z == 'Mac OS' && (Z = null), A = 'identify' + A) : (A =
        ...
        G == 'Safari' && A[1].slice(-1) == '+' ? (G = 'WebKit Nightly', O = 'alpha', D = A[1].slice(0, -1)) : D != A[
          1] && D != (A[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1]) || (D = null), A[1] = (/\bChrome\/([\d.]+)/i.exec(
          n) || 0)[1], A[0] == 537.36 && A[2] == 537.36 && parseFloat(A[1]) >= 28 && L == 'WebKit' && (L = ['Blink']),
        C && (f || A[1]) ? (L && (L[1] = 'like Chrome'), A = A[1] || ((A = A[0]) < 530 ? 1 : A < 532 ? 2 : A < 532.05
          ? 3 : A < 533 ? 4 : A < 534.03 ? 5 : A < 534.07 ? 6 : A < 534.1 ? 7 : A < 534.13 ? 8 : A < 534.16 ? 9 : A <
						...
						537.18 ? 24 : A < 537.24 ? 25 : A < 537.36 ? 26 : L != 'Blink' ? '27' : '28')) : (L && (L[1] = 'like Safari'),
        A = (A = A[0]) < 400 ? 1 : A < 500 ? 2 : A < 526 ? 3 : A < 533 ? 4 : A < 534 ? '4+' : A < 535 ? 5 : A < 537
          ? 6 : A < 538 ? 7 : A < 601 ? 8 : '8'), L && (L[1] += ' ' + (A += typeof A === 'number' ? '.x' : /[.+]/.test(A)
          ? '' : '+')), G == 'Safari' && (!D || parseInt(D) > 45) && (D = A)), G == 'Opera' && (A = /\bzbov|zvav$/.exec(
          Z)) ? (G += ' ', k.unshift('desktop mode'), A == 'zvav' ? (G += 'Mini', D = null) : G += 'Mobile', Z = Z.replace(
            RegExp(' *' + A + '$'), '')) : G == 'Safari' && /\bChrome\b/.exec(L && L[1]) && (k.unshift('desktop mode'),
          G = 'Chrome Mobile', D = null, /\bOS X\b/.test(Z) ? (R = 'Apple', Z = 'iOS 4.3+') : Z = null), D && D.indexOf(
          A = /[\d.]+$/.exec(Z)) == 0 && n.indexOf('/' + A + '-') > -1 && (Z = M(Z.replace(A, ''))), L && !/\b(?:Avant|Nook)\b/.test(G) && (/Browser|Lunascape|Maxthon/.test(G) || G != 'Safari' && /^iOS/.test(Z) &&
						/\bSafari\b/.test(L[1]) ||
          ...
          toString: function () {
            var e = this.version
            return this.family + (e && !a ? ' ' + e : '') + (this.architecture == 64 ? ' 64-bit' : '')
          }
						...
						o.platform) && !/\bWin64; x64\b/i.test(n)) && k.unshift('32-bit')) : Z && /^OS X/.test(Z.family) && G ==
					'Chrome' && parseFloat(D) >= 39 && (Z.architecture = 64), n || (n = null)
        var P = {}
  ...
  function t (n) {
    return typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? e.exports = t = function (e) {
      return typeof e
  ...
  e.exports = function (e, n) {
    if (!r(e)) return e
    var t, o
    if (n && typeof (t = e.toString) === 'function' && !r(o = t.call(e))) return o
    if (typeof (t = e.valueOf) === 'function' && !r(o = t.call(e))) return o
    if (!n && typeof (t = e.toString) === 'function' && !r(o = t.call(e))) return o
  ...
  e.exports = function (e) {
    var n, t, s
    return void 0 === e ? 'Undefined' : e === null ? 'Null' : typeof (t = (function (e, n) {
      try {
        return e[n]
      } catch (e) {}
    }(n = Object(e), o))) === 'string' ? t : i ? r(n) : (s = r(n)) == 'Object' && typeof n.callee === 'function' ? 'Arguments' : s
  }
}, function (e, n, t) {
  var r = t(33),
    o = t(20),
  ...
  e.exports = function (e) {
    ...
    return n.toString = function () {
      ...
      for (var s = 0; s < e.length; s++) {
        var A = e[s]
        A[0] != null && r[A[0]] || (t && !A[2] ? A[2] = t : t && (A[2] = '('.concat(A[2], ') and (').concat(t, ')')), n
          .push(A))
      }
    }, n
  }
  ...
  function l (e) {
    ...
    }), typeof e.insert === 'function') e.insert(n)
    else {
  ...
  function h (e, n) {
    ...
    if (n.singleton) {
      ...
      t = l(n), r = f.bind(null, t, n), o = function () {
        !(function (e) {
  ...
  e.exports = function (e, n) {
    (n = n || {}).attributes = typeof n.attributes === 'object' ? n.attributes : {}, n.singleton || typeof n
      .singleton === 'boolean' || (n.singleton = i())
    var t = A(e, n)
    return a(t, n),
    function (e) {
  ...
  var r, o, i = t(46),
    ...
    a = s,
    l = (r = /a/, o = /b*/g, s.call(r, 'a'), s.call(o, 'a'), r.lastIndex !== 0 || o.lastIndex !== 0),
    c = void 0 !== /()??/.exec('')[1];
  (l || c) && (a = function (e) {
    var n, t, r, o, a = this
  ...
  var r = (function (e) {
      ...
      return i._invoke = (function (e, n, t) {
        ...
        return function (o, i) {
          ...
          for (t.method = o, t.arg = i; ;) {
            ...
            a.type === 'throw' && (r = f, t.method = 'throw', t.arg = a.arg)
          }
        }
      }(e, t, s)), i
    }
          ...
          return new Promise(function (resolve, reject) {
            !(function n (t, o, i, s) {
              ...
              if (A.type !== 'throw') {
                var a = A.arg,
                  c = a.value
                return c && typeof c === 'object' && r.call(c, '__await') ? Promise.resolve(c.__await).then(function (e) {
                  n('next', e, i, s)
                }, function (e) {
                  n('throw', e, i, s)
    ...
    function w (e, t) {
      ...
      if (r === n) {
        if (t.delegate = null, t.method === 'throw') {
          if (e.iterator.return && (t.method = 'return', t.arg = n, w(e, t), t.method === 'throw')) return p
          t.method = 'throw', t.arg = new TypeError("The iterator does not provide a 'throw' method")
        }
        return p
      }
      var o = l(r, e.iterator, t.arg)
      if (o.type === 'throw') return t.method = 'throw', t.arg = o.arg, t.delegate = null, p
      var i = o.arg
      return i ? i.done ? (t[e.resultName] = i.value, t.next = e.nextLoc, t.method !== 'return' && (t.method = 'next',
    ...
    return h.prototype = M.constructor = j, j.constructor = h, j[A] = h.displayName = 'GeneratorFunction', e.isGeneratorFunction =
			function (e) {
			  var n = typeof e === 'function' && e.constructor
			  return !!n && (n === h || (n.displayName || n.name) === 'GeneratorFunction')
			}, e.mark = function (e) {
      ...
      reset: function (e) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = n, this.done = !1, this.delegate = null, this.method =
						'next', this.arg = n, this.tryEntries.forEach(x), !e) { for (var t in this) t.charAt(0) === 't' && r.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = n) }
      },
      stop: function () {
        this.done = !0
      ...
      abrupt: function (e, n) {
        ...
        i && (e === 'break' || e === 'continue') && i.tryLoc <= n && n <= i.finallyLoc && (i = null)
        var s = i ? i.completion : {}
        return s.type = e, s.arg = n, i ? (this.method = 'next', this.next = i.finallyLoc, p) : this.complete(s)
      },
      complete: function (e, n) {
        if (e.type === 'throw') throw e.arg
        return e.type === 'break' || e.type === 'continue' ? this.next = e.arg : e.type === 'return' ? (this.rval =
							this.arg = e.arg, this.method = 'return', this.next = 'end') : e.type === 'normal' && n && (this.next = n),
        p
      },
      finish: function (e) {
  ...
  e.exports = Object.create || function (e, n) {
    var t
    return e !== null ? (A.prototype = r(e), t = new A(), A.prototype = null, t[s] = e) : t = a(), void 0 === n ? t : o(
      t, n)
  }
}, function (e, n, t) {
  'use strict'
  ...
  e.exports = t(105)(Array, 'Array', function (e, n) {
    ...
    var e = this._t,
      n = this._k,
      t = this._i++
    return !e || t >= e.length ? (this._t = void 0, o(1)) : o(0, n == 'keys' ? t : n == 'values' ? e[t] : [t, e[t]])
  }, 'values'), i.Arguments = i.Array, r('keys'), r('values'), r('entries')
}, function (e, n, t) {
  e.exports = !t(4) && !t(7)(function () {
    return Object.defineProperty(t(42)('div'), 'a', {
      get: function () {
        return 7
      }
    }).a != 7
  ...
  e.exports = function (e) {
    return function (n, t, s) {
      var A, a = r(n),
        ...
        c = i(s, l)
      if (e && t != t) {
        for (; l > c;) { if ((A = a[c++]) != A) return !0 }
      } else {
        for (; l > c; c++) { if ((e || c in a) && a[c] === t) return e || c || 0 }
      }
      return !e && -1
    }
  }
  ...
  e.exports = function (e) {
    var n
    return r(e) && (void 0 !== (n = e[i]) ? !!n : o(e) == 'RegExp')
  }
}, function (e, n, t) {
  'use strict'
  var r = t(56),
  ...
  t(61)('split', 2, function (e, n, t, c) {
    var p
    return p = 'abbc'.split(/(b)*/)[1] == 'c' || 'test'.split(/(?:)/, -1).length != 4 || 'ab'.split(/(?:ab)*/).length != 2 ||
			'.'.split(/(.?)(.?)/).length != 4 || '.'.split(/()()/).length > 1 || ''.split(/.?/).length ? function (e, n) {
        var o = String(this)
        if (void 0 === e && n === 0) return []
      ...
      if (b === 0) return []
      if (v.length === 0) return a(g, v) === null ? [v] : []
      for (var m = 0, M = 0, y = []; M < v.length;) {
        g.lastIndex = f ? M : 0
        var z, w = a(g, f ? v : v.slice(M))
        if (w === null || (z = u(A(g.lastIndex + (f ? 0 : M)), v.length)) === m) M = s(v, M, h)
        else {
          if (y.push(v.slice(m, M)), y.length === b) return y
          for (var I = 1; I <= w.length - 1; I++) { if (y.push(w[I]), y.length === b) return y }
          M = m = z
        }
      }
  ...
  e.exports = function (e, n) {
    ...
    return void 0 === s || (t = r(s)[i]) == null ? n : o(t)
  }
}, function (e, n, t) {
  'use strict'
  var r = t(91)(!0)
    ...
    var v = A(e),
      ...
      p = f ? !i(function () {
        ...
        return t.exec = function () {
          return n = !0, null
        }, e === 'split' && (t.constructor = {}, t.constructor[l] = function () {
          return t
        }), t[v](''), !n
      }) : void 0
    if (!f || !p || e === 'replace' && !c || e === 'split' && !u) {
      var d = /./[v],
        ...
        j = h[0],
        g = h[1]
      r(String.prototype, e, j), o(RegExp.prototype, v, n == 2 ? function (e, n) {
  ...
  t(61)('replace', 2, function (e, n, t, p) {
    return [function (r, o) {
      ...
      for (var m, M = '', y = 0, z = 0; z < g.length; z++) {
        b = g[z]
        for (var w = String(b[0]), I = l(c(s(b.index), v.length), 0), x = [], E = 1; E < b.length; E++) {
          x.push(void 0 ===
					(m = b[E]) ? m : String(m))
        }
        var N = b.groups
      ...
      return void 0 !== s && (s = o(s), c = v), t.call(A, c, function (t, o) {
        ...
        switch (o.charAt(0)) {
          ...
          default:
            ...
            if (c > l) {
              var v = u(c / 10)
              return v === 0 ? t : v <= l ? void 0 === i[v - 1] ? o.charAt(1) : i[v - 1] + o.charAt(1) : t
            }
            A = i[c - 1]
        }
        return void 0 === A ? '' : A
  ...
  var r = t(0)('unscopables'),
    o = Array.prototype
  o[r] == null && t(11)(o, r, {}), e.exports = function (e) {
    o[r][e] = !0
  }
}, function (e, n, t) {
  'use strict'
  ...
  for (var r = t(50), o = t(18), i = t(10), s = t(1), A = t(11), a = t(25), l = t(0), c = l('iterator'), u = l(
    ...
    var h, j = p[d],
      ...
      b = s[j],
      m = b && b.prototype
    if (m && (m[c] || A(m, c, v), m[u] || A(m, u, j), a[j] = v, g)) { for (h in r) m[h] || i(m, h, r[h], !0) }
  }
}, function (e, n, t) {
  var r = t(24),
    o = t(18)
  ...
  v && f || (v = function (e) {
    ...
    return j[++h] = function () {
      A(typeof e === 'function' ? e : Function(e), n)
    }, r(h), h
  }, f = function (e) {
    delete j[e]
  }, t(15)(u) == 'process' ? r = function (e) {
    u.nextTick(s(g, e, 1))
  } : d && d.now ? r = function (e) {
    d.now(s(g, e, 1))
  } : p ? (i = (o = new p()).port2, o.port1.onmessage = b, r = s(i.postMessage, i, 1)) : c.addEventListener &&
		typeof postMessage === 'function' && !c.importScripts ? (r = function (e) {
      c.postMessage(e + '', '*')
  ...
  e.exports = function (e, n, t) {
    ...
    if (t) i = t(n)
      ...
      r.forEach(n, function (e, n) {
        e != null && (r.isArray(e) ? n += '[]' : e = [e], r.forEach(e, function (e) {
  ...
  (function (n) {
    ...
    var A, a = {
      adapter: (void 0 !== n && Object.prototype.toString.call(n) === '[object process]' ? A = t(75) : typeof XMLHttpRequest !==
				'undefined' && (A = t(75)), A),
  ...
  e.exports = function (e) {
    return new Promise(function (resolve, reject) {
				...
				function () {
				  if (v && v.readyState === 4 && (v.status !== 0 || v.responseURL && v.responseURL.indexOf('file:') === 0)) {
				    var t = 'getAllResponseHeaders' in v ? s(v.getAllResponseHeaders()) : null,
				      r = {
				        data: e.responseType && e.responseType !== 'text' ? v.response : v.responseText,
				        status: v.status,
      ...
      if ('setRequestHeader' in v && r.forEach(u, function (e, n) {
        void 0 === c && n.toLowerCase() === 'content-type' ? delete u[n] : v.setRequestHeader(n, e)
      }), e.withCredentials && (v.withCredentials = !0), e.responseType) {
        try {
          v.responseType = e.responseType
        } catch (n) {
          if (e.responseType !== 'json') throw n
        }
      }
      typeof e.onDownloadProgress === 'function' && v.addEventListener('progress', e.onDownloadProgress), typeof e.onUploadProgress ===
				'function' && v.upload && v.upload.addEventListener('progress', e.onUploadProgress), e.cancelToken &&
  ...
  'use strict'
  e.exports = function (e, n) {
    return typeof (e = e.__esModule ? e.default : e) !== 'string' ? e : (/^['"].*['"]$/.test(e) && (e = e.slice(1, -1)),
  ...
  e.exports = function (e, n) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (o = 0; o < s.length; o++) {
        t = s[o], n.indexOf(t) >= 0 || Object.prototype.propertyIsEnumerable.call(e, t) &&
				(i[t] = e[t])
      }
    }
    return i
  ...
  e.exports = !l || t(7)(function () {
    ...
    return e[t] = 7, r.split('').forEach(function (e) {
      n[e] = e
    }), l({}, e)[t] != 7 || Object.keys(l({}, n)).join('') != r
  }) ? function (e, n) {
      for (var t = A(e), l = arguments.length, c = 1, u = i.f, v = s.f; l > c;) {
        for (var f, p = a(arguments[c++]), d = u ? o(p).concat(u(p)) : o(p), h = d.length, j = 0; h > j;) {
          f = d[j++], r &&
				!v.call(p, f) || (t[f] = p[f])
        }
      }
  ...
  t(4) && /./g.flags != 'g' && t(6).f(RegExp.prototype, 'flags', {
    configurable: !0,
    get: t(46)
  })
}, function (e, n, t) {
  ...
  var r = t(1),
    ...
    g = function (e) {
      ...
      if (typeof n === 'string' && n.length > 2) {
        ...
        if (i === 43 || i === 45) {
          if ((t = n.charCodeAt(2)) === 88 || t === 120) return NaN
        } else if (i === 48) {
          ...
          for (var s, a = n.slice(2), l = 0, c = a.length; l < c; l++) { if ((s = a.charCodeAt(l)) < 48 || s > o) return NaN }
          return parseInt(a, r)
        }
      }
      return +n
  ...
  if (!f(' 0o1') || !f('0b1') || f('+0x1')) {
    f = function (e) {
      ...
      return t instanceof f && (h ? a(function () {
        d.valueOf.call(t)
      }) : i(t) != 'Number') ? s(new p(g(n)), t, f) : g(n)
    }
    for (var b, m = t(4) ? l(p)
  ...
  e.exports = function (e, n, t) {
    ...
    return s !== t && typeof s === 'function' && (i = s.prototype) !== t.prototype && r(i) && o && o(e, i), e
  }
}, function (e, n, t) {
  var r = t(9),
    o = t(2),
    i = function (e, n) {
      if (o(e), !r(n) && n !== null) throw TypeError(n + ": can't set as prototype!")
    }
  e.exports = {
  ...
  e.exports = function (e, n, t, p, d, h, j) {
    ...
    var g, b, m, M = function (e) {
      ...
      T = n == 'Array' && I.entries || x
    if (T && (m = c(T.call(new e()))) !== Object.prototype && m.next && (l(m, y, !0), r || typeof m[u] === 'function' ||
				s(m, u, f)), z && x && x.name !== 'values' && (w = !0, E = function () {
      return x.call(this)
      ...
      if (g = {
        ...
        keys: h ? E : M('keys'),
        entries: N
      }, j) { for (b in g) b in I || i(I, b, g[b]) } else o(o.P + o.F * (v || w), n, g)
    }
    return g
  }
}, function (e, n, t) {
  ...
  e.exports = Object.getPrototypeOf || function (e) {
    return e = o(e), r(e, i) ? e[i] : typeof e.constructor === 'function' && e instanceof e.constructor ? e.constructor
  ...
  var r, o, i, s, A = t(22),
    ...
    S = !!(function () {
      try {
        ...
        return (N || typeof PromiseRejectionEvent === 'function') && e.then(T) instanceof n && x.indexOf('6.6') !== 0 && M.indexOf('Chrome/66') === -1
      } catch (e) {}
    }()),
    B = function (e) {
      var n
      return !(!v(e) || typeof (n = e.then) !== 'function') && n
    },
    k = function (e, n) {
      if (!e._n) {
        e._n = !0
        var t = e._c
        g(function () {
          for (var r = e._v, o = e._s == 1, i = 0, s = function (n) {
            var t, i, s, A = o ? n.ok : n.fail,
              a = n.resolve,
              l = n.reject,
              c = n.domain
            try {
              A ? (o || (e._h == 2 && D(e), e._h = 1), !0 === A ? t = r : (c && c.enter(), t = A(r), c && (c.exit(), s = !0)), t === n.promise ? l(z('Promise-chain cycle')) : (i = B(t)) ? i.call(t, a, l) : a(t)) : l(r)
            } catch (e) {
              c && !s && c.exit(), l(e)
            }
          }; t.length > i;) s(t[i++])
  ...
  S || (E = function (e) {
    ...
    then: function (e, n) {
      var t = Y(h(this, E))
      return t.ok = typeof e !== 'function' || e, t.fail = typeof n === 'function' && n, t.domain = N ? w.domain
  ...
  (n = e.exports = function (e, n, t, u, v) {
    var f, p, d, h, j = v ? function () {
      ...
      g = r(t, u, n ? 2 : 1),
      b = 0
    if (typeof j !== 'function') throw TypeError(e + ' is not iterable!')
    if (i(j)) {
      for (f = A(e.length); f > b; b++) { if ((h = n ? g(s(p = e[b])[0], p[1]) : g(e[b])) === l || h === c) return h }
    } else {
      for (d = j.call(e); !(p = d.next()).done;) { if ((h = o(d, g, p.value, n)) === l || h === c) return h }
    }
  }).BREAK = l, n.RETURN = c
}, function (e, n, t) {
  var r = t(2)
  ...
  r(r.S, 'Object', {
    getOwnPropertyDescriptors: function (e) {
      for (var n, t, r = i(e), a = s.f, l = o(r), c = {}, u = 0; l.length > u;) {
        void 0 !== (t = a(r, n = l[u++])) &&
				A(c, n, t)
      }
      return c
  ...
  var r = t(1),
    ...
    V = P && typeof k.iterator === 'symbol' ? function (e) {
    ...
    ee = function (e) {
      for (var n, t = e === F, r = B(t ? Z : M(e)), i = [], s = 0; r.length > s;) {
        !o(R, n = r[s++]) || t && !o(F, n) ||
				i.push(R[n])
      }
      return i
  ...
  s(s.S + s.F * !P, 'Symbol', {
    ...
    keyFor: function (e) {
      ...
      for (var n in Q) { if (Q[n] === e) return n }
    },
    useSetter: function () {
      W = !0
    },
  ...
  s(s.S + s.F * ie, 'Object', {
    ...
    stringify: function (e) {
      ...
      if (t = n = r[1], (b(n) || void 0 !== e) && !V(e)) {
        return j(n) || (n = function (e, n) {
          if (typeof t === 'function' && (n = t.call(this, e, n)), !V(n)) return n
        }), r[1] = n, C.apply(O, r)
      }
    }
  ...
  e.exports = function (e) {
    var n = r(e),
      t = o.f
    if (t) { for (var s, A = t(e), a = i.f, l = 0; A.length > l;) a.call(e, s = A[l++]) && n.push(s) }
    return n
  }
}, function (e, n, t) {
  var r = t(15)
  ...
  e.exports.f = function (e) {
    return s && i.call(e) == '[object Window]' ? (function (e) {
      try {
        return o(e)
      } catch (e) {
        return s.slice()
  ...
  /*!
	 ...
	 */
  e.exports = function (e) {
    return e != null && e.constructor != null && typeof e.constructor.isBuffer === 'function' && e.constructor.isBuffer(
      e)
  }
}, function (e, n, t) {
  'use strict'
  ...
  a.prototype.request = function (e) {
    typeof e === 'string' ? (e = arguments[1] || {}).url = arguments[0] : e = e || {}, (e = A(this.defaults, e)).method =
  ...
  o.nextTick = function (e) {
    ...
    l.push(new p(e, n)), l.length !== 1 || c || A(f)
  ...
  e.exports = function (e) {
    ...
    return e ? (r.forEach(e.split('\n'), function (e) {
      if (i = e.indexOf(':'), n = r.trim(e.substr(0, i)).toLowerCase(), t = r.trim(e.substr(i + 1)), n) {
        ...
        s[n] = n === 'set-cookie' ? (s[n] ? s[n] : []).concat([t]) : s[n] ? s[n] + ', ' + t : t
      }
    }), s) : s
  }
}, function (e, n, t) {
  ...
  var r = t(26),
    ...
    f = (t(98), t(66), t(50), t(67), t(109), {
      ...
      setStyle: function (e, n) {
        o()(n) === 'object' && Object.keys(n).forEach(function (t) {
          e.style[t] = n[t]
        })
      },
      ...
      setValue: function (e) {
        return typeof Number(e) !== 'number' ? e : e < 10 ? '0'.concat(e) : e
      },
  ...
  var x = p.logsFunction(),
      ...
      return v()(e, [{
        ...
        value: function (e, n) {
          var t = e.streamId,
            ...
            a = y.a.name,
            l = a === 'Firefox' || a === 'IE' || a === 'Microsoft Edge',
            c = this.isMobile
          t || (t = 1), r || (r = location.protocol === 'http:' ? '1' : '2'), o || (c ? o = 'hls' : l ? n === '1' && t ===
						1 ? o = 'hls' : (o = 'rtsp', this.browserWarn()) : o = 'rtsp')
        ...
        value: function () {
          this.playerStatus.isMuted = !0, this.videoJsPlayer && this.videoJsPlayer.dispose(), this.videoPlayer && this
            ...
            .root.removeChild(this.canvasEl), this.videoEl && this.root.removeChild(this.videoEl)), this.isPlaying = !1, this.canvasPlayer = null, this.videoJsPlayer = null, this.videoPlayer = null, p.setAttr(this.btnPlay,
            'class', 'player__btn player__btn-large iconfont iconbofang'), this.tipDom.innerHTML = ''
        }
      }, {
        key: 'setVolume',
        value: function (e) {
          typeof e === 'number' ? e > 1 || e < 0 ? E('Param of volume must be between from 0 to 1') : (this.videoJsPlayer &&
						(this.videoJsPlayer.muted(!e), this.videoJsPlayer.volume(e)), this.videoPlayer && (this.videoPlayer.muted = !e, this.videoPlayer.volume = e), this.canvasPlayer && this.canvasPlayer.setAudioVolume(e)) : E(
        ...
        value: function () {
          ...
          this.videoPlayer = null), this.canvasPlayer) {
            try {
              ...
              switch (j.prev = j.next) {
                case 0:
                  if (n = {
                    ...
                    isSuccess: !1,
                    playUrl: ''
                  }, t = e.kitToken, r = e.deviceId, o = e.channelId, i = e.type, j.prev = 2, s = location, s.protocol
                    .indexOf('http') !== -1) {
                    j.next = 8
                    break
                  }
                ...
                case 12:
                  c = j.sent, console.log(c), u = (new Date()).getTime() - l, console.log('获取播放地址耗时: '.concat(u / 1e3,
                    's')), v = c.data, c.status === 200 ? (f = v.result.data, d = v.result.code, h = v.result.msg, d ===
										'0' ? (n.playUrl = f.url, n.isSuccess = !0) : n.message = h || '获取播放地址失败') : n.message = '获取播放地址失败',
                  j.next = 24
                  break
                case 20:
              ...
              switch (h.prev = h.next) {
                ...
                case 48:
                  ...
                  this.canvasEl.style.width = '100%', this.canvasEl.style.height = '100%', this.canvasEl.style.display =
									...
									u.protocol, f = {
                    wsURL: ''.concat(v === 'http:' && this.playUrl.indexOf('8556') === -1 ? 'ws' : 'wss', '://').concat(
                      c),
    ...
    S = (function () {
      ...
      return v()(e, [{
        ...
        key: 'setVolume',
        value: function (e) {
          typeof e === 'number' ? e > 1 || e < 0 ? Y('Param of volume must be between from 0 to 1') : this.playerSet.forEach(
            function (n) {
              n.setVolume(e)
        ...
        value: function () {
          ...
          var n = this.options,
            ...
            s = void 0 === i ? '400' : i,
            A = ['string', 'number']
          A.includes(o()(r)) && A.includes(o()(s)) ? (typeof r === 'number' ? e.width = ''.concat(r, 'px') : r.indexOf(
            'px') === -1 && r.indexOf('%') === -1 ? e.width = ''.concat(r, 'px') : e.width = r, typeof s === 'number' ? e.height =
						''.concat(s, 'px') : s.indexOf('px') === -1 && s.indexOf('%') === -1 ? e.height = ''.concat(s, 'px') : e.height =
        ...
        value: function (e) {
          this.btnFullScreen = e.querySelector('#playerFullScreen'), this.playerSplit1 = e.querySelector(
            ...
            .addEventListener('click', this.setMultiScreen.bind(this, 9)), y.a.os.family !== 'iOS' && this.btnFullScreen
        ...
        value: function (e) {
          var n = {},
            ...
            c = a[1],
            u = a[2]
          if (/^[0-9A-Za-z]+$/i.test(l) && /^\d{1,3}$/.test(c) && ['1', '2'].includes(u)) {
            return i && i.split('&').forEach(
              function (e) {
                var t = e.split('='),
                  r = s()(t, 2),
                  o = r[0],
        ...
        value: function (e) {
          var n = !1,
            t = y.a.name
          return (t === 'Firefox' || t === 'IE' || t === 'Microsoft Edge') && e.streamType && e.streamType === 'rtsp' &&
						(n = !0), n
        }
      }, {
        key: 'renderPlayer',
        value: function (e, n) {
          ...
          n === 2 && (A.width = '50%', A.height = '50%'), n === 4 && (A.width = '50%', A.height = '50%'), n === 9 && (
            A.width = '33.33%', A.height = '33.33%'), p.setAttr(this.container, 'class', 'player__split--'.concat(n))
          for (var a = [], l = 0, c = this.container.children.length; l < c; l++) {
            l > n - 1 ? (this.container.removeChild(
              this.container.children[n]), this.playerSet[l] && this.playerSet[l].destroy()) : this.container
              .children[l].dataset.player === 'true' && a.push(this.container.children[l])
          }
          for (var u = 0; u < a.length; u++) {
            a[u].style.width = A.width, a[u].style.height = A.height, n === 2 ? p.setStyle(
              a[u], {
